...
export function TalentData() {
  ...
  return (
    <>
    <div className="h-full flex flex-row items-center justify-center py-28  md:h-auto dark:bg-black bg-white relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        <div className="abslute w-full -bottom-20 h-72 md:h-full z-10">
          <World
            data={sampleData}
